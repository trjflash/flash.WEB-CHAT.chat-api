...
class ChatApi
{
    protected $token = 'oycyoxh358s1yvd8';
    protected $url = 'https://eu191.chat-api.com/instance195686/';
     ...
     * @param string $url
     */
    public function __construct($token, $url = 'https://eu191.chat-api.com/instance195686/')
    {
        $this->token = $token;
        $this->url = $url;
    }
